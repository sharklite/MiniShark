        ...
        try {
            ...
            for (T entity:collection){
                ...
                if(transfer.autoIncrementCol!=null){
                    ...
                    if(rsAuto.next()) {
                        long auto=rsAuto.getLong(transfer.autoIncrementCol);
                        Field field=transfer.fields.get(transfer.colFieldMapper.get(transfer.autoIncrementCol));
                        if(field!=null){
                            Class fieldType=field.getType();
                            if(fieldType.equals(Long.class)||fieldType.equals(long.class))
                                transfer.setFieldValue(transfer.colFieldMapper.get(transfer.autoIncrementCol),auto);
                            else
                                transfer.setFieldValue(transfer.colFieldMapper.get(transfer.autoIncrementCol),(int)auto);
                        }
                    }
